...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "Support_Encyclopedia" because\n';
  ...
  $wnd.__gwt_activeModules['Support_Encyclopedia'] = {
    'moduleName' : 'Support_Encyclopedia',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/Support_Encyclopedia.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['Support_Encyclopedia'].superdevmode = true;

  var expectedSuffix = '/Support_Encyclopedia.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + Support_Encyclopedia + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:Support_Encyclopedia';
  var devModeSessionKey = '__gwtDevModeSession:Support_Encyclopedia';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/Support_Encyclopedia/Support_Encyclopedia.nocache.js';
  ...
  $wnd.__gwt_activeModules['Support_Encyclopedia'].canRedirect = true;
  $wnd.__gwt_activeModules['Support_Encyclopedia'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING Support_Encyclopedia';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/Support_Encyclopedia?user.agent=' + ua + '&_callback=' + callback;
