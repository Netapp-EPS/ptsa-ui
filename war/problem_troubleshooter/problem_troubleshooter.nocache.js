...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "problem_troubleshooter" because\n';
  ...
  $wnd.__gwt_activeModules['problem_troubleshooter'] = {
    'moduleName' : 'problem_troubleshooter',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/problem_troubleshooter.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['problem_troubleshooter'].superdevmode = true;

  var expectedSuffix = '/problem_troubleshooter.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + problem_troubleshooter + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:problem_troubleshooter';
  var devModeSessionKey = '__gwtDevModeSession:problem_troubleshooter';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/problem_troubleshooter/problem_troubleshooter.nocache.js';
  ...
  $wnd.__gwt_activeModules['problem_troubleshooter'].canRedirect = true;
  $wnd.__gwt_activeModules['problem_troubleshooter'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING problem_troubleshooter';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/problem_troubleshooter?user.agent=' + ua + '&_callback=' + callback;
